...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
    <div class="w-container">
      <nav role="navigation" class="w-nav-menu"><a href="#" class="navbtn w-button">Notifications</a></nav><a href="admin.php" class="nav-link w-nav-link">Home</a><a href="admin.php" class="nav-link w-nav-link w--current">Admin</a><a href="index.php" class="nav-link w-nav-link">Sign Out</a>
    ...
    <div class="w-row">
      ...
      <div class="w-col w-col-6">
        <div class="hero-card">
          ...
          <h5>&quot;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore...”</h5><a href="#" class="btn-outline w-button">Button Text</a>
        </div>
      </div>
    </div>
  </div>
