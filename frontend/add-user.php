...
<!--  Last Published: Wed Nov 27 2019 15:04:41 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="5dde8e08ea470385cb0093cd" data-wf-site="5dd89354578babc32818ce3f">
<head>
  <meta charset="utf-8">
  ...
  <meta content="Add user" property="og:title">
...
<body>
  <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar w-nav">
    <div class="w-container">
     </nav><a href="index.php" class="nav-link w-nav-link">Home</a><a href="admin.php" class="nav-link w-nav-link">Admin</a><a href="index.php" class="nav-link w-nav-link">Sign Out</a>
  ...
  <div class="hero-section">
    <div class="form-columns w-row">
      ...
      <div class="w-col w-col-6"><img src="images/add-user.png" srcset="images/add-user.png 500w, images/add-user.png 751w" sizes="(max-width: 479px) 92vw, (max-width: 767px) 87vw, 41vw" alt=""></div>
    </div>
  </div>
